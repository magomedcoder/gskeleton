...
const file_v1_user_proto_rawDesc = "" +
	"\n" +
	"\rv1/user.proto\x12\x16gskeleton.http.v1.user\x1a\x13tagger/tagger.proto\"~\n" +
	"\x04User\x12\x1e\n" +
	...
	"\x04name\x18\x03 \x01(\tB\x10\x9a\x84\x9e\x03\vjson:\"name\"R\x04name\"\xc3\x02\n" +
	...
	"\x04name\x18\x03 \x01(\tBB\x9a\x84\x9e\x03=form:\"name\" json:\"name\" binding:\"required,min=2\" label:\"name\"R\x04name\"4\n" +
	"\x12CreateUserResponse\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\x9a\x84\x9e\x03\tjson:\"id\"R\x02id\"\x82\x01\n" +
	"\x10GetUsersResponse\x12'\n" +
	"\x05total\x18\x01 \x01(\x03B\x11\x9a\x84\x9e\x03\fjson:\"total\"R\x05total\x12E\n" +
	"\x05items\x18\x02 \x03(\v2\x1c.gskeleton.http.v1.user.UserB\x11\x9a\x84\x9e\x03\fjson:\"items\"R\x05items\"\x89\x01\n" +
	"\x0fGetUserResponse\x12\x1e\n" +
	"\x02id\x18\x01 \x01(\x03B\x0e\x9a\x84\x9e\x03\tjson:\"id\"R\x02id\x120\n" +
	"\busername\x18\x02 \x01(\tB\x14\x9a\x84\x9e\x03\x0fjson:\"username\"R\busername\x12$\n" +
	"\x04name\x18\x03 \x01(\tB\x10\x9a\x84\x9e\x03\vjson:\"name\"R\x04nameB2Z0github.com/magomedcoder/gskeleton/api/http/pb/v1b\x06proto3"
...
var file_v1_user_proto_goTypes = []any{
	(*User)(nil),               // 0: gskeleton.http.v1.user.User
	(*CreateUserRequest)(nil),  // 1: gskeleton.http.v1.user.CreateUserRequest
	(*CreateUserResponse)(nil), // 2: gskeleton.http.v1.user.CreateUserResponse
	(*GetUsersResponse)(nil),   // 3: gskeleton.http.v1.user.GetUsersResponse
	(*GetUserResponse)(nil),    // 4: gskeleton.http.v1.user.GetUserResponse
}
var file_v1_user_proto_depIdxs = []int32{
	0, // 0: gskeleton.http.v1.user.GetUsersResponse.items:type_name -> gskeleton.http.v1.user.User
